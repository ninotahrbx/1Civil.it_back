...
/**
 * La classe JWTService fournit des opérations liées à JWT (JSON Web Token) telles que la génération,
 * Extraction des réclamations, validation et gestion des jetons.
 *
